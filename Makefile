cute3d: geometry.c cute3d.c io.c matrix.c transform.c debug.c quaternion.c shader.c render.c solid.c text.c ascii.c
	...
	gcc -g -std=c99 -fPIC cute3d.c -o cute3d text.o ascii.o solid.o render.o geometry.o shader.o transform.o matrix.o quaternion.o debug.o io.o -lallegro -lallegro_main -lallegro_video -lGL -lGLEW -lglut
