...
void main() {
    ...
    // - offset final projected vertex a little towards the camera
    float epsilon = 0.00001 * dir_correction;
    vec3 camera_offset = epsilon * normalize(eye_position - current_projected.xyz);
    current_projected.xyz += camera_offset;
