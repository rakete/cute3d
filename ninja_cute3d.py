...
if build_platform == "linux" or build_toolset == "gcc":
    if ninja_build.command_exists("sdl2-config"):
    ...
    if ninja_build.command_exists("sdl2-config") and ninja_build.command_exists("sh"):
...
ninja_build.copy(w, build_platform)
ninja_build.mkdir(w, build_platform)
ninja_build.glsl_validate(w)
ninja_build.xxd(w, source_directory)
...
shaders = ninja_build.build_shaders(w, build_platform, source_directory, build_directory, script_directory, "shader")
