...
int32_t main(int32_t argc, char *argv[]) {
    ...
    vbomesh_create_from_solid(&solid_out, (Color){ 255, 255, 0, 255 }, &vbo, &vbomesh);
    ...
    while (true) {
        ...
        draw_grid(&global_dynamic_canvas, 0, 12.0f, 12.0f, 12, (Color){20, 180, 240, 255}, grid_transform);
